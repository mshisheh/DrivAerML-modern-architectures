"""
Training Script for FIGConvNet on DrivAerNet

Trains FIGConvNet model for surface pressure prediction.
...
def main():
    parser = argparse.ArgumentParser(description='Train FIGConvNet on DrivAerNet')
    ...
    parser.add_argument('--hidden_dim', type=int, default=64,
                        help='Hidden dimension (default: 64 for ~3M params)')
    ...
    # Output
    parser.add_argument('--save_dir', type=str, default='./checkpoints/figconvnet',
                        help='Directory to save checkpoints')
    parser.add_argument('--log_dir', type=str, default='./logs/figconvnet',
    ...
    # Create model
    print("\nCreating FIGConvNet model...")
    hidden_channels = [args.hidden_dim * (2**i) for i in range(args.num_levels)]
